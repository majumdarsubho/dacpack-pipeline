    ...
    stages {
        stage('Build schema') {
            steps {
                ...
                /var/lib/jenkins/sqlpackage/sqlpackage /action:Publish /SourceFile:$DIR /TargetDatabaseName:test /tsn:demo-db.cof6rbxdsl87.us-east-1.rds.amazonaws.com /tu:admin /tp:"IBMHertz-Project121"
                '''
